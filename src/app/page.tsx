			...
			<div className="bg-white shadow-md rounded-lg p-8 max-w-md w-full flex flex-col min-h-screen">
				...
				<div className="flex flex-col gap-2 mb-6">
					...
					<button
						...
						className={`bg-green-700 hover:bg-green-800 text-white font-bold py-2 px-4 rounded-md w-full sm:w-auto transition-colors duration-200 ${
							isLoading || !animalName.trim() ? "opacity-50 cursor-not-allowed" : ""
						}`}
					>
				...
				<h1 className="text-3xl font-bold text-gray-800 mb-6 text-center">{animalData?.name}</h1>

				{error && (
					<p className="text-red-500 text-center text-xl mb-2 -mt-6 font-medium">{error}</p>
				)}
				...
				{animalData && (
					<div className="mb-4">
						<h3 className="text-lg font-semibold text-gray-700 mb-2">Found in:</h3>
