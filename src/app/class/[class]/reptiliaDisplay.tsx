...
// --- Specific Component for Reptilia ---
// This could be moved to its own file: src/components/ReptiliaDisplay.tsx
export function ReptiliaDisplay({ data }: ClassDisplayProps) {
		...
		<div className="max-w-4xl mx-auto bg-white rounded-lg shadow-xl p-6 sm:p-10">
			...
			<section className="mb-10">
				...
				{data.description.map((paragraph) => (
					<p key={paragraph.slice(0, 10)} className="text-gray-700 leading-relaxed mb-4">
						{paragraph}
					</p>
				))}
			</section>
