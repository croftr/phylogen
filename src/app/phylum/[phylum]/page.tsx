...
const data: { [key: string]: string } = {
	Chordata:
		"Chordata is a phylum of animals that includes all vertebrates, as well as several invertebrates. The defining characteristics of chordates are: Notochord, a flexible rod that runs along the length of the body",
};
...
export default function PhylumPage() {
	...
	const backgroundImage =
		!imageError && images[phylum] ? images[phylum] : "/images/default-phylum.jpg";
		...
		<div className="min-h-screen min-w-screen relative bg-gray-100 pt-30 text-gray-600">
			...
			<div className="relative z-20 flex flex-col items-center justify-start p-6 min-h-screen">
				<div className="bg-white shadow-md rounded-lg p-8 max-w-4xl w-full">
					<h1 className="text-3xl font-bold text-gray-800 mb-6">Phylum: {phylum}</h1>

					<p className="mb-4">{phylumDetail ? phylumDetail.description : data[phylum]}</p>
					{phylumDetail?.subgroups && (
